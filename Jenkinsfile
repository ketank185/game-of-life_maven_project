	...
	stages {
		...
		stage ("downloading apache tomcat and deploying war in webapps") {
			steps {
				...
				sh 'ansible all -bm copy -a "src=/var/lib/jenkins/workspace/ansible-2/gameoflife-web/target/gameoflife.war dest=/home/mayu/home/mayu/apache-tomcat-9.0.73/webapps"'
